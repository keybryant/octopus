...
export interface PriorityPickerProps {
  value: "P0" | "P1" | "P2"
  onChange: (p: "P0" | "P1" | "P2") => void
  label?: string
}

const OPTIONS: { value: "P0" | "P1" | "P2"; hint: string }[] = [
  { value: "P0", hint: "紧急" },
  { value: "P1", hint: "高" },
  { value: "P2", hint: "普通" },
]

const activeClasses: Record<"P0" | "P1" | "P2", string> = {
...
export function usePriorityPicker(initial: "P0" | "P1" | "P2" = "P1") {
  return useState<"P0" | "P1" | "P2">(initial)
}
